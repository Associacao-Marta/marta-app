    ...
    <Grid container>
      ...
      <Grid container item className="conteudoContainer-Onboarding">
        <p className="body2" style={{ paddingLeft: 8, paddingRight: 8 }}>
          Aprenda a distinguir os tipos de violência de gênero, entenda como a violência acontece e
          conheça as leis e serviços que garantem os direitos das mulheres.
        </p>
      </Grid>
      ...
      <Grid item>
        <MobileStepper
          ...
          nextButton={
            <Button href="A4" size="small" onClick={handleNext} disabled={activeStep === 3}>
              Avançar
              {theme.direction === 'rtl' ? <KeyboardArrowLeft /> : <KeyboardArrowRight />}
            </Button>
          }
          backButton={
            <Button href="A2" size="small" onClick={handleBack} disabled={activeStep === 0}>
