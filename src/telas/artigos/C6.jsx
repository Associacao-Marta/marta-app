        ...
        <Grid container item className="containerArtigo" id="target">
          <div className="content">
            <LeiaMais className="leiaMais">
              <p>
                Em geral, as formas de violências são bastante diversas, mas existem alguns
                comportamentos que ajudam a identificar que uma pessoa está sofrendo com isso, como
                quando uma mulher vive aterrorizada, temendo ataques por não conseguir proteger os
                seus filhos e a si mesma.
              </p>
              <p>
                Além disso, algo bastante sintomático é quando a mulher se isola dos seus familiares
                e amigos por pressão ou por vergonha ou, ainda, perde a sua liberdade de ir aonde
                deseja, de estudar e de trabalhar.
              </p>
            </LeiaMais>
          </div>
        </Grid>
