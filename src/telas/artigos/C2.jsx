          ...
          <div className="content">
            <LeiaMais className="leiaMais">
              ...
              <p>
                ...
                sociais com o objetivo de conscientizar e educar os estudantes e a comunidade, a fim
                de que se tornem cidadãos mais responsáveis, sensíveis aos temas relacionados à
                causa da Associação.
              </p>
              <p>
                Também promovemos projetos de assistência jurídica e psicológica gratuitas para
                vítimas de violência contra a mulher.
              </p>
              <b>Por que fazemos?</b>
              <p>
                Acreditamos na importância da conscientização por meio de palestras e pelas redes
                sociais, tendo em vista que muitas mulheres e adolescentes não sabem identificar as
                formas de violência, não estando preparadas para se proteger delas. Ainda, este
                método nos possibilita capacitar o público-alvo para perceber, se sensibilizar e dar
                suporte quando se depara com uma situação de violência.
              </p>
              <b>Contatos</b>
              <p>
                Instagram:{' '}
