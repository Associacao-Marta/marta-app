...
const C13 = () => {
  return (
    <Grid container className="">
      ...
      <HeaderTitulo img={img} titulo="Locais de Apoio" chip="Conheça a aplicação"></HeaderTitulo>
        ...
        <Grid container item className="containerArtigo" id="target">
          <div className="content">
            <LeiaMais className="leiaMais">
              <p>
                Garantir o amparo e suporte às mulheres vítimas de violência é extremamente
                necessário. Para isso, por meio de uma rede de serviços
