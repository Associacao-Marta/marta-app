...
const C7 = () => {
  return (
    <Grid container className="">
      ...
      <HeaderTitulo img={img} titulo="Feminicídio" chip="Legislação"></HeaderTitulo>
        ...
        <Grid container item className="containerArtigo" id="target">
          <div className="content">
            <LeiaMais className="leiaMais">
              <p>
                A Lei do Feminicídio (Lei Federal 13.104/15) criminaliza, como seu próprio nome
                sugere, a conduta de prática do feminicídio, que é o homicídio de mulheres cometido
                em razão do gênero, ou seja, a vítima é morta em razão de ser mulher.
              </p>
              <p>
                O Brasil é considerado o quinto país do mundo com maior número de feminicídios, fato
                este que demonstra por si só a importância dessa legislação que está entrou somente
                em 2015 e pode ser consultada no link a seguir:
                <br />
                <b>
