...
const C11 = () => {
  return (
    <Grid container className="">
      ...
      <HeaderTitulo img={img} titulo="Artigos" chip="Conheça a aplicação"></HeaderTitulo>
        ...
        <Grid container item className="containerArtigo" id="target">
          <div className="content">
            <LeiaMais className="leiaMais">
              <p>
                É sempre importante adquirir novos conhecimentos, especialmente quando se trata de
                um assunto sério e recorrente como violência de gênero, as maneiras de combater esse
                crime e apoiar as mulheres que o vivenciam.
              </p>
              <p>
                Para seguir nessa missão, o app Associação Marta apresenta um conjunto de conteúdos
                educacionais e informativos localizados na página de <b>Artigos</b> que vão lhe
                ajudar a se informar sobre diversos assuntos, como distinguir os tipos de violência
                de gênero, como costumam acontecer os casos, as leis e serviços que garantem o
                direito e suporte às mulheres, entre outros tipos de informações.
              </p>
            </LeiaMais>
          </div>
        </Grid>
