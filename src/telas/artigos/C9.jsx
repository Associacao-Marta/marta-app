          ...
          <div className="content">
            <LeiaMais className="leiaMais">
              <p>
                ...
                tornou-se um dos princípios do Sistema Único de Saúde (SUS) de forma a garantir,
                entre outros direitos, o acompanhamento psicológico e cirurgias plásticas
                reparadoras, se for o caso, como se pode ver em maiores detalhes a seguir:
              </p>
              <p>
                <b>
