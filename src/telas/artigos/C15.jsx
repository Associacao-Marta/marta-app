...
const C15 = () => {
  return (
    <Grid container className="">
      ...
      <HeaderTitulo img={img} titulo="Quem desenvolveu" chip="Conheça a aplicação"></HeaderTitulo>
          ...
          <div className="content">
            <LeiaMais className="leiaMais">
              <p>
                ...
                Sistemas e Mídias Digitais da Universidade Federal do Ceará, em parceria com a
                Associação Marta. O produto foi projetado pela equipe Os Cappuccinos, composta pelo
              ...
              <p>
                <b>Lucas de Oliveira</b> - Desenvolvedor, Analista de Requisitos e Arquiteto da
                Informação (<a href="https://www.linkedin.com/in/lucasmdoliveira/">Linkedin</a>)
              </p>
              <p>
