        ...
        <Grid container item className="containerArtigo" id="target">
          <LeiaMais className="leiaMais">
            <p>
              ...
              ajuda é algo visto de maneira vergonhosa por muitas das vítimas e
              gera muito medo.
            </p>
            <p>
              Ainda, algo bastante comum é que sempre resta alguma esperança de
              que tudo se resolva e que o agressor mude o seu comportamento de
              maneira rápida.
            </p>
            <p>
              ...
              lidar com essas situações, culpabilizando a vítima, inclusive, por
              algo que ela está sofrendo, o que demonstra a existência de muitos
