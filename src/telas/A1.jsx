  ...
  return (
    <Grid container>
      ...
      <Grid container item className="conteudoContainer-Onboarding">
        <p className="body2">
          Olá! Seja bem-vinda ao aplicativo da Associação Marta. Nossa missão é atuar na prevenção e
          conscientização da violência contra a mulher.
        </p>
      </Grid>
      ...
      <Grid item>
        <MobileStepper
          ...
          nextButton={
            <Button href="A2" size="small" onClick={handleNext} disabled={activeStep === 2}>
              Avançar
