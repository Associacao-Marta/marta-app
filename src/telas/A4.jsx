    ...
    <Grid container>
      ...
      <Grid container item className="conteudoContainer-Onboarding">
        <p className="body2" style={{ paddingLeft: 8, paddingRight: 8 }}>
          Marque um dia e horário para receber assistência da Associação Marta. Obtenha conforto
          psicológico e orientação jurídica de profissionais.
        </p>
      </Grid>
      ...
      <Grid item>
        <MobileStepper
          ...
          nextButton={
            <Button href="A5" size="small" onClick={handleNext} disabled={activeStep === 4}>
              Avançar
              {theme.direction === 'rtl' ? <KeyboardArrowLeft /> : <KeyboardArrowRight />}
            </Button>
          }
          backButton={
            <Button href="A3" size="small" onClick={handleBack} disabled={activeStep === 0}>
